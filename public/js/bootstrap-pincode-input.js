...
(function ($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
        ...
        updateOriginalInput: function () {
            let newValue = "";
            $(".pincode-input-text", this._container).each(function (
                index,
                value
            ) {
        ...
        buildInputBoxes: function () {
            this._container = $("<div />").addClass(
                this.settings.containerclass + " pincode-input-container"
            );
            ...
            if (this.settings.placeholders) {
                ...
                touchplaceholders = this.settings.placeholders.replace(
                    / /g,
                    ""
                );
            }
            ...
            if (
                this.settings.hidedigits == false &&
                $(this.element).val() != ""
            ) {
            ...
            if (this._isTouchDevice()) {
                ...
                setTimeout(function () {
                    let digitWidth =
                        parseFloat(getComputedStyle(input.get(0)).fontSize) *
                        digitEms;
            ...
            // error box
            this._error = $("<div />")
                .addClass(this.settings.errorclass + " pincode-input-error")
                ...
                $.proxy(function (e) {
                    ...
                    if (this._isTouchDevice()) {
                        if (e.keyCode == 8 || e.keyCode == 46) {
                            ...
                            $(this.element).val().length == this.settings.inputs
                        ) {
                            e.preventDefault();
                            e.stopPropagation();
                        } else if (
